    ...
    <div class="main-panel">
      ...
      <?php
        ...
        if (isset($_GET['id'])) {
          ...
          $stid = oci_parse($con,"SELECT * FROM barang WHERE id_brng = '$id'");
          oci_execute($stid);
      ...
      <form class="form-horizontal" action="proses_update_barang.php" method="post">
       <div class="form-row">
          ...
          <input type="hidden" class="form-control" name="id_brng" value="<?= $d['id_brng'] ?>" >
        <div class="form-group col-md-6">
          <label for="">NAMA BARANG</label>
          <input type="text" class="form-control" name="nm_brng" value="<?= $d['nm_brng'] ?>">
        </div>
        <div class="form-group col-md-6">
